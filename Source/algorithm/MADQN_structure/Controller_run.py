...
class MADQNAgentController:
    ...
    def create_agent(self, map_xdim, map_ydim):
        ...
        if self.control_mode == "train_NN":
            ...
            policy_net = torch.load("/home/ubuntu/Doan/results su dung dc/layout8_end/rb_p.pt")
            target_net = torch.load("/home/ubuntu/Doan/results su dung dc/layout8_end/rb_t.pt")
